class LookImage {
  ...
  const allImages = [
    ...
    new LookImage("image78.jpg", true, true, "Le sartorialisme est un art qui transcende les frontières et les cultures. Il n’est pas l’apanage d’une élite occidentale, mais une célébration de la beauté vestimentaire dans toute sa diversité. C’est un hommage à la créativité humaine, à l’ingéniosité des artisans du monde entier, et à la richesse des traditions textiles qui nous unissent tous."),
    new LookImage("image79.jpg", true, true, "Le sartorialisme est un art qui transcende les frontières et les cultures. Il n’est pas l’apanage d’une élite occidentale, mais une célébration de la beauté vestimentaire dans toute sa diversité. C’est un hommage à la créativité humaine, à l’ingéniosité des artisans du monde entier, et à la richesse des traditions textiles qui nous unissent tous."),
new LookImage("image80.jpg", true, true, "Le sartorialisme est un art qui transcende les frontières et les cultures. Il n’est pas l’apanage d’une élite occidentale, mais une célébration de la beauté vestimentaire dans toute sa diversité. C’est un hommage à la créativité humaine, à l’ingéniosité des artisans du monde entier, et à la richesse des traditions textiles qui nous unissent tous."),
new LookImage("image81.jpg", true, true, "Le sartorialisme est un art qui transcende les frontières et les cultures. Il n’est pas l’apanage d’une élite occidentale, mais une célébration de la beauté vestimentaire dans toute sa diversité. C’est un hommage à la créativité humaine, à l’ingéniosité des artisans du monde entier, et à la richesse des traditions textiles qui nous unissent tous."),
new LookImage("image82.jpg", true, true, "Le sartorialisme est un art qui transcende les frontières et les cultures. Il n’est pas l’apanage d’une élite occidentale, mais une célébration de la beauté vestimentaire dans toute sa diversité. C’est un hommage à la créativité humaine, à l’ingéniosité des artisans du monde entier, et à la richesse des traditions textiles qui nous unissent tous."),  
